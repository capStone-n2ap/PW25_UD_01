...
def objective(trial):
    ...
    scheduler_name = trial.suggest_categorical('scheduler_name', ['constant', 'cosine', 'linear'])

    # Data paths 
    train_path = r"C:\Users\Student\Desktop\CML_HPO\dataset\kinetics\kinetics\train"
    val_path = r"C:\Users\Student\Desktop\CML_HPO\dataset\kinetics\kinetics\validation"
    ...
    model = create_model(num_labels=7, num_frames=num_frames, dropout_rate=dropout_rate)
...
def main():
    ...
    storage_name = "sqlite:///optuna_7classKinetics_base_percentile_pruning.db"    
    sampler_file = "7classKinetics_base_percentile.pkl"  # File to save sampler state
